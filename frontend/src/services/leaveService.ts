...
export const leaveService = {
  ...
  createLeaveType: async (data: CreateLeaveTypeDTO): Promise<LeaveType> => {
    const response = await api.post('/leaves/leave-types', data);
  ...
  getLeaveType: async (id: string): Promise<LeaveType> => {
    const response = await api.get(`/leaves/leave-types/${id}`);
    return response.data;
  },
  ...
  updateLeaveType: async (
    ...
    const response = await api.put(`/leaves/leave-types/${id}`, data);
    return response.data;
  },

  deleteLeaveType: async (id: string): Promise<void> => {
    await api.delete(`/leaves/leave-types/${id}`);
  },
  ...
  getHoliday: async (id: string): Promise<CompanyHoliday> => {
    const response = await api.get(`/leaves/holidays/${id}`);
    return response.data;
  },
  ...
  approveLeave: async (id: string): Promise<void> => {
    await api.put(`/leaves/leaves/${id}/approve`);
  },

  rejectLeave: async (id: string, reason: string): Promise<void> => {
    await api.put(`/leaves/leaves/${id}/reject`, { reason });
  },
  ...
  getLeaveBalance: async (
    ...
    const response = await api.get(`/leaves/leaves/balance/${employeeId}`, {
      params: { year },
    });
    return response.data;
  },
  ...
  getTeamLeaveCalendar: async (): Promise<LeaveCalendarEntry[]> => {
    const response = await api.get('/leaves/leaves/team-calendar');
    return response.data;
  },
};
