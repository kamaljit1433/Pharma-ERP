...
router.delete('/jobs/:id', authenticateToken, authorize([UserRole.SUPER_ADMIN, UserRole.HR_MANAGER]) as any, (req, res) => controller.deleteJobPosting(req, res));
router.put('/jobs/:id/status', authenticateToken, authorize([UserRole.SUPER_ADMIN, UserRole.HR_MANAGER]) as any, (req, res) => controller.updateJobPostingStatus(req, res));
...
router.put('/interviews/:interview_id', authenticateToken, authorize([UserRole.SUPER_ADMIN, UserRole.HR_MANAGER]) as any, (req, res) => controller.updateInterview(req, res));
router.delete('/interviews/:interview_id', authenticateToken, authorize([UserRole.SUPER_ADMIN, UserRole.HR_MANAGER]) as any, (req, res) => controller.deleteInterview(req, res));
...
// Offer Letter routes
router.get('/offer-letters', authenticateToken, authorize([UserRole.SUPER_ADMIN, UserRole.HR_MANAGER]) as any, (req, res) => controller.getOfferLetters(req, res));
...
router.delete('/offer-letters/:offer_letter_id', authenticateToken, authorize([UserRole.SUPER_ADMIN, UserRole.HR_MANAGER]) as any, (req, res) => controller.deleteOfferLetter(req, res));
...
// Google Forms sync — manually pull new responses from all active job posting forms
router.post('/forms/sync', authenticateToken, authorize([UserRole.SUPER_ADMIN, UserRole.HR_MANAGER]) as any, (req, res) => controller.syncFormResponses(req, res));
